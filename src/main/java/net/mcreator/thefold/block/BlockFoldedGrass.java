...
public class BlockFoldedGrass extends ElementsTheFold.ModElement {
	@GameRegistry.ObjectHolder("thefold:foldedgrass")
	public static final Block block = null;
	public BlockFoldedGrass(ElementsTheFold instance) {
		super(instance, 28);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("thefold:foldedgrass", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("foldedgrass");
			setRegistryName("foldedgrass");
		}
