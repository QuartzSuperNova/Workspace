...
import net.mcreator.thefold.procedure.ProcedureEntityEntersTar;
import net.mcreator.thefold.ElementsTheFold;

@ElementsTheFold.ModElement.Tag
public class BlockTar extends ElementsTheFold.ModElement {
	@GameRegistry.ObjectHolder("thefold:tar")
		...
		elements.blocks.add(() -> new BlockFluidClassic(fluid, Material.WATER) {
			...
			public void onEntityCollidedWithBlock(World world, BlockPos pos, IBlockState state, Entity entity) {
				...
				int z = pos.getZ();
				{
					...
					ProcedureEntityEntersTar.executeProcedure($_dependencies);
				}
			}
		}.setUnlocalizedName("tar").setRegistryName("tar"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		ModelLoader.setCustomMeshDefinition(item, new ItemMeshDefinition() {
			...
			public ModelResourceLocation getModelLocation(ItemStack stack) {
				return new ModelResourceLocation("thefold:tar", "tar");
			}
		});
