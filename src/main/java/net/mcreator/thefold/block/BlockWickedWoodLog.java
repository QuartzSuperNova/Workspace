...
public class BlockWickedWoodLog extends ElementsTheFold.ModElement {
	@GameRegistry.ObjectHolder("thefold:wickedwoodlog")
	public static final Block block = null;
	public BlockWickedWoodLog(ElementsTheFold instance) {
		super(instance, 32);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("wickedwoodlog"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("thefold:wickedwoodlog", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("wickedwoodlog");
